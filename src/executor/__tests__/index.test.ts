...
import { createExecutor, createTestRunner, BunExecutor, PythonExecutor, TestRunner } from "../index.js";
...
describe("createExecutor", () => {
  ...
  it("should throw error for unsupported language", () => {
    expect(() => createExecutor("ruby" as any)).toThrow("Unsupported language");
  });
});
...
describe("createTestRunner", () => {
  ...
  it("should create runner with correct executor for typescript", () => {
    ...
    const executor = (runner as any).executor;
    expect(executor).toBeInstanceOf(BunExecutor);
  });
